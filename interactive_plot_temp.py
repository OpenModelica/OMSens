...
def main():
    ...
    plotter_kwargs = getInteractiveArguments(csvs_paths_list)
    plotting.plot_csv.multipleCSVsAndVarsSimplePlotTemp(**plotter_kwargs)
    logger.debug("Plotted succesfully")

def getInteractiveArguments(csvs_paths_list):
    ...
    csvs_path_label_pair_list = csvs_paths_list
...
def getCommandLineArguments():
    ...
    parser.add_argument('csvs_paths_list', metavar='csvs_paths_list',nargs="+",help='The csvs paths (preferably absolute paths) to plot in the same plot.')
